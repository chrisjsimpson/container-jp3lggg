...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jp3lggg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jp3lggg.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-jp3lggg.git
cd container-jp3lggg
```
...
```
docker attach container-jp3lggg
```
